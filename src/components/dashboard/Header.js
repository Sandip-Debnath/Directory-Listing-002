...
export default function DashboardHeader() {
    const user = useAppSelector(s => s.auth.user) ?? storage.get("auth_user", null);
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul className="navbar-nav">
                    <li className="nav-item">
                        <a className="nav-link" href="/"><i className="typcn typcn-point-of-interest-outline top-menu-icon"></i>Home</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link" href="/dashboard"><i className="typcn typcn-point-of-interest-outline top-menu-icon"></i>Dashboard</a>
                    </li>
                    ...
                    <li className="nav-item">
                        <a className="nav-link" href="/listings"><i className="typcn typcn-point-of-interest-outline top-menu-icon"></i>Explore</a>
                    </li>
                    ...
                    <li className="nav-item dropdown user-menu user-menu-custom">
                        <a className="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <div className="profile-element d-flex align-items-center flex-shrink-0 p-0 text-start">
                                ...
                                <div className="profile-text">
                                    <h6 className="m-0 fw-medium fs-14">{user?.name ?? "Guest"}</h6>
                                    <span><span className="__cf_email__">{user?.email ?? ""}</span></span>
                                </div>
                            </div>
                        </a>
                        <div className="dropdown-menu">
                            ...
                            <div className="user-header">
                                ...
                                <span><a href="https://themes.easital.com/cdn-cgi/l/email-protection" className="__cf_email__">{user?.email ?? ""}</a></span>
                            </div>
